              ...
              <div className="grid max-w-md grid-cols-1 mx-auto lg:grid-cols-12 gap-x-6 gap-y-8 lg:max-w-none">
                <div className="self-center lg:col-span-4">
                  ...
                  <div className="relative inline-flex mt-9 group">
                    ...
                    <a href="#" title=""
                      className="relative inline-flex items-center justify-center px-8 py-3 sm:text-sm sm:py-3.5 text-base font-semibold text-white transition-all duration-200 bg-green-600 border border-transparent rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-600"
                      role="button">
                      Read Exclusive Blog
                    </a>
                  </div>
                  ...
                  <div className="mt-6 space-y-6 lg:space-y-8">
                    <div className="relative overflow-hidden">
                      <div className="flex items-start lg:items-center">
                        <Image className="object-cover w-12 h-12 rounded-lg shrink-0" src="https://res.cloudinary.com/dysxcljt2/image/upload/v1695297820/yoga/thumbnail-3_qxtfw4.png" alt="" width={1920} height={1920} />
                ...
                <div className="self-end lg:col-span-5">
                  <Image className="w-full mx-auto" src="https://res.cloudinary.com/dysxcljt2/image/upload/v1695297618/yoga/author_etetco.png" alt="" width={1920} height={1920} />
                </div>
              </div>
            </div>
          </section>
