            ...
            <div className="divide-y divide-gray--200 -my-9">
                ...
                <div className="py-9">
                    ...
                    <p className="mt-3 text-base text-gray-600">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt <a href="#" title="" className="text-blue-600 transition-all duration-200 hover:text-blue-700 focus:text-blue-700 hover:underline">support@rk.com</a>
                    </p>
                </div>
            </div>
        </div>
