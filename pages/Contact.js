  ...
  <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-4 lg:gap-8">
    ...
    <a className="flex flex-col h-full text-center rounded-md hover:bg-gray-100 p-4 sm:p-6 dark:hover:bg-white/[.05]" href="#">
      ...
      <div className="grow">
        ...
        <p className="mt-1 text-gray-500">We are here to help with any questions or code</p>
        <p className="mt-5 inline-flex items-center gap-x-2 font-medium text-green-600 dark:text-green-500">
          Contact support
